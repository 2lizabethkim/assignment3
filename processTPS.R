...
myFowardSortationArea <- table(TPSdata$Forward_Sortation_Area)
cat("Postal code/s with the largest number of incidents (", sort(myFowardSortationArea, decreasing = TRUE)[1], '):')


cat(rownames(sort(myFowardSortationArea, decreasing = TRUE)[1]))
